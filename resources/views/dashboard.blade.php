        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('sondage.read',['id'=>$lastsondage->id])}}" class="btn btn-primary">Voir plus</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('question.read',['id'=>$lastquestion->id])}}" class="btn btn-primary">Voir plus</a>
                </div>
            </div>
        </div>
    </div>
