          ...
          <div class="row gutters-sm">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ auth()->user()->image }}" alt="Admin" class="rounded-circle" width="150" height="150">
                    <div class="mt-3">
            ...
            <div class="col-md-8">
                <div class="card mb-3">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-info px-8" target="__blank" href="{{route('profile.view',['id'=>$user->id])}}">Modifier le profil</a>
            ...
            <div class="counter">
                <div class="row">
                    ...
                    <div class="col-6 col-lg-4">
                        <div class="count-data text-center">
                            <h6 class="count h2">{{ $nbresponse }}</h6>
