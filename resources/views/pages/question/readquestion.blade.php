                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        @foreach ($reponses as $reponse)
                            ...
                            <h5 class="card-title">{{ $reponse->user_id }}</h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Signaler la question de : {{ $questions->user_id }}
                    </h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('report.add.topic') }}" method="POST">
                        @csrf
                        <input type="text" name="type" id="type" value="{{ $questions->type }}">
