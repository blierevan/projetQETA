...
<div class="container">
    ...
    <tbody>
        ...
        <td><a class="btn btn-danger" href="{{route('admin.question.commentaire.delete',['id'=>$commentaire->id])}}"><i class="fas fa-minus-circle"></i></a> 
            <a class="btn btn-info" href="{{route('admin.question.commentaire.edit.view',['id'=>$commentaire->id])}}"><i class="fas fa-pen"></i></a></td>
      </tr>
      @endforeach
      
    </tbody>
  </table>
  <a href="{{route('admin.question.commentaire.add.view',['id'=>$questions->id])}}" class="btn btn-success w-25">Ajouter un commentaire</a>
@endsection
